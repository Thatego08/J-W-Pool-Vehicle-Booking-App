    ...
    public class VehicleDbContext : DbContext
    {
       ...
       new Status { Id = 7, Name = "In-Progress" }
           ...
           new InsuranceCover { InsuranceCoverId = 3, InsuranceCoverName = " Third-party " });
            ...
            {
                entity.Property(v => v.CabinType).HasMaxLength(50);
                entity.Property(v => v.DriveType).HasMaxLength(10);
                entity.Property(v => v.Transmission).HasMaxLength(20);
                entity.Property(v => v.HasTowBar).HasDefaultValue(false);
                entity.Property(v => v.HasCanopy).HasDefaultValue(false);

                entity.Property(v => v.Protection).HasMaxLength(50);
                entity.Property(v => v.Compliance).HasMaxLength(50);
            });
            ...
            modelBuilder.Entity<Vehicle>().HasData(
                ...
                new Vehicle { VehicleID = 4, Name = "Toyota 3",VehicleModelID = 2, VehicleMakeID = 11, Description = "DC HILUX 2.4 GD-6 RAIDER 4X4 A/T", DateAcquired = new DateTime(2024, 7, 24), RegistrationNumber = "LR 01 CT GP", InsuranceCoverID = 1, VIN = "AHTKB3CD802676867", ColourID = 2, FuelTypeID = 2, EngineNo = "2GDD364709", LicenseExpiryDate = new DateTime(2028, 5, 31), StatusID = 1,
                    ...
                    HasTowBar = true,   // From Excel "Tow bar"
                    HasCanopy = false,
                ...
                new Vehicle {VehicleID = 8, Name = "Toyota 7", VehicleModelID = 2, VehicleMakeID = 11, Description = "DC, 4X4 ( With Canopy ) ", DateAcquired = new DateTime(2016, 11, 18), RegistrationNumber = "FN 57 RR GP", InsuranceCoverID = 1, VIN = "AHTKB3CD302604992", ColourID = 2, FuelTypeID = 2, EngineNo = "2GD0195958", LicenseExpiryDate = new DateTime(2023, 10, 31), StatusID = 1, CabinType = "Double", DriveType = "4x4", Transmission = "Manual", HasTowBar = true, HasCanopy = true,
                    Compliance = "Sasol Secunda",
                    Protection = ""
                },
                new Vehicle {VehicleID = 9, Name = "Toyota 8", VehicleModelID = 2, VehicleMakeID = 11, Description = "DC, 4x4", DateAcquired = new DateTime(2016, 11, 18), RegistrationNumber = "FN 57 ST GP", InsuranceCoverID = 1, VIN = "AHTK3CD202605213", ColourID = 2, FuelTypeID = 2, EngineNo = "2GD0207661", LicenseExpiryDate = new DateTime(2023, 10, 31), StatusID = 1, CabinType = "Double", DriveType = "4x4", Transmission = "Manual", HasTowBar = false, HasCanopy = false,
                    Compliance = "Sishen",
                    Protection = ""
                },
                ...
                new Vehicle {VehicleID = 15, Name = "Toyota 14", VehicleModelID = 2, VehicleMakeID = 11, Description = " Extra Cab HiluxXC 2.4 GD6 RBRAI 6MT ( A1P )  ", DateAcquired = new DateTime(2023, 4, 1), RegistrationNumber = "LB 93 JV GP", InsuranceCoverID = 1, VIN = "AHTJB3DC104496782", ColourID = 2, FuelTypeID = 2, EngineNo = "2GDD138062", LicenseExpiryDate = new DateTime(2023, 10, 31), StatusID = 1, CabinType = "Extra", DriveType = "4x2", Transmission = "Manual", HasTowBar = false, HasCanopy = false },
                new Vehicle {VehicleID = 16, Name = "Toyota 15", VehicleModelID = 2, VehicleMakeID = 11, Description = "SUV 1.8 XR CVT ", DateAcquired = new DateTime(2022, 10, 19), RegistrationNumber = "KV 84 DV GP ", InsuranceCoverID = 1, VIN = "AHTKFBAG500614236", ColourID = 2, FuelTypeID = 2, EngineNo = "2ZRW975634", LicenseExpiryDate = new DateTime(2023, 9, 30), StatusID = 1, CabinType = "SUV", DriveType = "4x2", Transmission = "Automatic", HasTowBar = false, HasCanopy = false },
