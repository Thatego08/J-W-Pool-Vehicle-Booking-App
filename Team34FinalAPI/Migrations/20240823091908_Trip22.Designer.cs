...
namespace Team34FinalAPI.Migrations
{
    ...
    [Migration("20240823091908_Trip22")]
    partial class Trip22
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Team34FinalAPI.Models.TripMedia", b =>
                {
                    ...
                    b.Property<int>("PostCheckId1")
                        .HasColumnType("int");

                    b.Property<int>("PostCheckId2")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Team34FinalAPI.Models.TripMedia", b =>
                {
                    ...
                    b.HasOne("Team34FinalAPI.Models.PostCheck", null)
                        .WithMany("TripMedia")
                        .HasForeignKey("PostCheckId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
